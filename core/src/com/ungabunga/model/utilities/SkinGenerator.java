...
public class SkinGenerator {
    public static Skin generateSkin(AssetManager assetManager) {
        Skin skin = new Skin();
        if (!assetManager.isLoaded("pic/packed/uipack.atlas")) {
            throw new GdxRuntimeException("uipack.atlas was not loaded");
        }
        TextureAtlas uiAtlas = assetManager.get("pic/packed/uipack.atlas");
        ...
        BitmapFont smallFont = assetManager.get("pic/font/small_letters_font.fnt", BitmapFont.class);
